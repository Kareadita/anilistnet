...
public class MediaReview
{
    ...
    /// </summary>
    [GqlSelection("summary")]
    public string Summary { get; private set; }

    /// <summary>
    /// For which type of media the review is for.
    /// </summary>
    [GqlSelection("mediaType")]
    ...
    [GqlSelection("userRating")]
    public MediaReviewRating UserRating { get; private set; }
}
