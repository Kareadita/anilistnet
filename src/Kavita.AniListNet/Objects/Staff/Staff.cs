...
public class Staff
{
    ...
    /// </summary>
    [GqlSelection("primaryOccupations")]
    public string[] PrimaryOccupations { get; private set; }
    ...
    /// </summary>
    [GqlSelection("age")]
    public int? Age { get; private set; } // TODO: Check if age is non-nullable

    /// <summary>
    /// [startYear, endYear] (If the 2nd value is not present staff is still active)
    /// </summary>
    [GqlSelection("yearsActive")]
    public int[] YearsActive { get; private set; }

    /// <summary>
    /// The persons birthplace or hometown.
    /// </summary>
    [GqlSelection("homeTown")]
    ...
    /// </summary>
    /// <remarks>Requires user authentication with AniList!</remarks>
    [GqlSelection("isFavouriteBlocked")]
    public bool IsFavoriteBlocked { get; private set; }
}
