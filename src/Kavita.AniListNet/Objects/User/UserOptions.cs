...
public class UserOptions
{
    ...
    /// </summary>
    [GqlSelection("titleLanguage")]
    public UserMediaTitleLanguage MediaTitleLanguage { get; private set; }

    /// <summary>
    /// Whether the user has enabled viewing of 18+ content.
    /// </summary>
    [GqlSelection("displayAdultContent")]
    public bool DisplayAdultContent { get; private set; }

    /// <summary>
    /// Whether the user receives notifications when a show they are watching aires.
    /// </summary>
    [GqlSelection("airingNotifications")]
    public bool ReceiveAiringNotifications { get; private set; }
